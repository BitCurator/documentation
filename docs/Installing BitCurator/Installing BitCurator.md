 ...
 * [Install Option 1: Installation via Dedicated Machine] (_This is the preferred method for running the BitCurator Environment._)
 * [Install Option 2: Installation via Virtual Machine](Install Option 2: Installation via Virtual Machine)
